...
function uploadFile() {
    ...
    $.ajax({
        url: app.hosts.api + '/api/file/upload',
        type: 'POST',
        data: formData,
        dataType: 'json',
        async: false,
...
(function ($) {
    $.fn.dragDropOrPaste = function (onUploading, onUploaded, postData) {
        ...
        this.on('pasteImage', function (ev, data) {
            ...
            $.post(app.hosts.api + '/api/file/upload', postargs, function (result) {
                if (onUploaded)
                    onUploaded(result);
            }, 'json');
        });
...
function _bindSingle(dom) {
    var time = new Date(dom.attr('datetime')).getTime();
    dom.html(time);
